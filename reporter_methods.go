...
func (r *Reporter) writeScoreSection(sb *strings.Builder, report *StructuralReport) {
...
func (r *Reporter) writeViolationsSummary(sb *strings.Builder, report *StructuralReport) {
	sb.WriteString("┌───────────────────────────────────────────────────────────┐\n")
...
func (r *Reporter) writeCircularViolations(sb *strings.Builder, report *StructuralReport) {
...
func (r *Reporter) writeLayerViolations(sb *strings.Builder, report *StructuralReport) {
...
func (r *Reporter) writeSizeViolations(sb *strings.Builder, report *StructuralReport) {
...
func (r *Reporter) writeGodObjectViolations(sb *strings.Builder, report *StructuralReport) {
...
func (r *Reporter) writeScoreBreakdown(sb *strings.Builder, report *StructuralReport) {
